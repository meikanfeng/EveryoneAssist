...
import com.example.everyoneassist.Utils.DensityUtils;
import com.example.everyoneassist.View.Pull.internal.EmptyViewMethodAccessor;
import com.example.everyoneassist.View.Pull.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T>
	...
	private void addIndicatorViews() {
		...
		if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
			...
			params.rightMargin = getResources().getDimensionPixelSize(DensityUtils.dip2px(getContext(),10f));
