 ...
 *******************************************************************************/
package com.example.everyoneassist.View.Pull;
...
import com.example.everyoneassist.View.Pull.internal.FlipLoadingLayout;
import com.example.everyoneassist.View.Pull.internal.LoadingLayout;
import com.example.everyoneassist.View.Pull.internal.RotateLoadingLayout;
import com.example.everyoneassist.View.Pull.internal.Utils;
import com.example.everyoneassist.View.Pull.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public void addView(View child, int index, ViewGroup.LayoutParams params) {
		if (DEBUG) {
			DebugLog.d(LOG_TAG, "addView: " + child.getClass().getSimpleName());
		}
	...
	public final void setMode(Mode mode) {
		if (mode != mMode) {
			if (DEBUG) {
				DebugLog.d(LOG_TAG, "Setting mode to: " + mode);
			}
			mMode = mode;
			updateUIForMode();
		}
	...
	final void setState(State state, final boolean... params) {
		mState = state;
		if (DEBUG) {
			DebugLog.d(LOG_TAG, "State: " + mState.name());
		}
	...
	protected final void onSizeChanged(int w, int h, int oldw, int oldh) {
		if (DEBUG) {
			DebugLog.d(LOG_TAG, String.format("onSizeChanged. W: %d, H: %d", w, h));
		}
	...
	protected final void refreshLoadingViewsSize() {
		...
		if (DEBUG) {
			DebugLog.d(LOG_TAG, String.format("Setting Padding. L: %d, T: %d, R: %d, B: %d", pLeft, pTop, pRight, pBottom));
		}
	...
	protected final void setHeaderScroll(int value) {
		if (DEBUG) {
			DebugLog.d(LOG_TAG, "setHeaderScroll: " + value);
		}
