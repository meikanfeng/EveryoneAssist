...
public class AddSkillListActivity extends BaseActivity implements ReleaseNeedAdapter.OnItemClickListener, HttpPostRequestUtils.HttpPostRequestCallback {
    ...
    private void initView() {
        ...
        releaseNeedAdapter = new ReleaseNeedAdapter(this, null);
